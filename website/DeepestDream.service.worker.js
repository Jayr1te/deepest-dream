...
/** @type {string} */
const CACHE_VERSION = '1760716648|1153710551';
/** @type {string} */
const CACHE_PREFIX = 'DeepestDream-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'DeepestDream.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["DeepestDream.html","DeepestDream.js","DeepestDream.offline.html","DeepestDream.icon.png","DeepestDream.apple-touch-icon.png","DeepestDream.audio.worklet.js","DeepestDream.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["DeepestDream.wasm","DeepestDream.pck"];
